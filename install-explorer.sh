...
#git clone https://github.com/chmex/bitcore-node-komodo
#git clone https://github.com/chmex/insight-api-komodo 
#git clone https://github.com/chmex/insight-ui-komodo

#git clone https://github.com/chmex/bitcore-lib-komodo
#git clone https://github.com/chmex/bitcore-message-komodo
#git clone https://github.com/chmex/bitcore-build-komodo
...
npm install git+https://git@github.com/chmex/bitcore-node-komodo # npm install bitcore
...
cd $i-explorer
$CUR_DIR/node_modules/bitcore-node-komodo/bin/bitcore-node install git+https://git@github.com/chmex/insight-api-komodo git+https://git@github.com/chmex/insight-ui-komodo
cd $CUR_DIR
